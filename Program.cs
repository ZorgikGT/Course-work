    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while(true)
            {
                ...
                Console.WriteLine("6.Сведения о фермерах");
                Console.WriteLine("7.Сведения о продукции");
                Console.WriteLine("8.Сведения о потребностях");
                ...
                switch (userResponse)
                {
                    ...
                    case 5: 
                        ...
                        var countProducts = FarmersProductsList.Count(product => product.KeySecond == productKey);
                        for(int i = 0; i < countProducts; i++) {
                            var removingFarmersProduct = FarmersProductsList.Where(product => product.KeySecond == productKey).First();
                            FarmersProductsList.Remove(removingFarmersProduct);
                        }
                        using (StreamWriter sw = new StreamWriter(FarmersProductsPath, false, System.Text.Encoding.Default))
                        {
                            foreach (JoinType product in FarmersProductsList)
                            {
                                sw.WriteLine(product.Information());
                            }
                        }
                    ...
                    case 6:
                        foreach (Farmer farmer in FarmersList)
                        {                            
                            Console.WriteLine(farmer.Key + ":" + farmer.Name + ":" + farmer.Address + ":" + farmer.Region);
                        }
                    ...
                    case 7:
                        foreach (Product product in ProductsList)
                        {                            
                            Console.WriteLine(product.Key + ":" + product.ProductName + ":" + product.Quality + ":" + product.Price + ":" + product.Count);
                        }
                    ...
                    case 8:
                        ...
                        {                            
                            Console.WriteLine(need.Key + ":" + need.Name + ":" + need.Service + ":" + need.Price);
                        }
